...
---
module: atlas_entity
short_description: Create, update, classify, and delete individual Apache Atlas entities
description:
  - Manage (create, update, delete, classify) individual Apache Atlas entities.
...
class AtlasEntity(AnsibleModule):
